...
BOOST_FIXTURE_TEST_CASE(logging_LogPrintStr, LogSetup)
{
    ...
    LogInstance().LogPrintStr("foo1: bar1", "fn1", source_locs[0], BCLog::LogFlags::NET, BCLog::Level::Debug, /*should_ratelimit=*/false);
    LogInstance().LogPrintStr("foo2: bar2", "fn2", source_locs[1], BCLog::LogFlags::NET, BCLog::Level::Info, /*should_ratelimit=*/false);
    LogInstance().LogPrintStr("foo3: bar3", "fn3", source_locs[2], BCLog::LogFlags::ALL, BCLog::Level::Debug, /*should_ratelimit=*/false);
    LogInstance().LogPrintStr("foo4: bar4", "fn4", source_locs[3], BCLog::LogFlags::ALL, BCLog::Level::Info, /*should_ratelimit=*/false);
    LogInstance().LogPrintStr("foo5: bar5", "fn5", source_locs[4], BCLog::LogFlags::NONE, BCLog::Level::Debug, /*should_ratelimit=*/false);
    LogInstance().LogPrintStr("foo6: bar6", "fn6", source_locs[5], BCLog::LogFlags::NONE, BCLog::Level::Info, /*should_ratelimit=*/false);
...
BOOST_AUTO_TEST_CASE(logging_sourcelocation_counter)
{
    ...
    BOOST_CHECK_EQUAL(counter.GetAvailableBytes(), BCLog::LogRateLimiter::WINDOW_MAX_BYTES);
    ...
    BOOST_CHECK_EQUAL(counter.GetAvailableBytes(), BCLog::LogRateLimiter::WINDOW_MAX_BYTES - MESSAGE_SIZE);
    BOOST_CHECK_EQUAL(counter.GetDroppedBytes(), 0ull);

    BOOST_CHECK(counter.Consume(MESSAGE_SIZE));
    BOOST_CHECK_EQUAL(counter.GetAvailableBytes(), BCLog::LogRateLimiter::WINDOW_MAX_BYTES - MESSAGE_SIZE * 2);
    BOOST_CHECK_EQUAL(counter.GetDroppedBytes(), 0ull);
