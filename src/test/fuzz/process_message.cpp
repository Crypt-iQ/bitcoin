...
FUZZ_TARGET(process_message, .init = initialize_process_message)
{
    ...
    ReachabilityGoal(initial_sequence != end_sequence, "process_message changes the mempool");
    ReachabilityGoal(initial_block_index_size != end_block_index_size, "process_message changes the block index");
