...
namespace BCLog {
    ...
    private:
        ...
        uint64_t m_available_bytes{LogRateLimiter::WINDOW_MAX_BYTES};
    ...
    private:
        ...
        void LogPrintStr_(std::string_view str, std::string_view logging_function, const std::source_location& source_loc, BCLog::LogFlags category, BCLog::Level level, bool should_ratelimit)
