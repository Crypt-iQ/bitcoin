...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-blocksxor",
                   strprintf("Whether an XOR-key applies to blocksdir *.dat files. "
                             "If disabled, the blocksdir must be completely empty or the key stored in the blocksdir must be empty. "
                             "The created XOR-key will be empty for an existing blocksdir and random for a freshly initialized blocksdir. "
                             "(default: %u)",
